...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/([
	     ...
	     **
	     > Parameters
	     **
	     - index.jsp (number) position of the deletion
	     ...
	     **
	     = (function) returned function accepts a single numeric parameter that represents z-index.jsp of the handler. It is an optional feature and only used when you need to ensure that some subset of handlers will be invoked in a given order, despite of the order of assignment.
	     > Example:
	     ...
	     * Note: I assume most of the time you don’t need to worry about z-index.jsp, but it’s nice to have this feature “just in case”.
	    \*/
